...
function padString(original, length, padWith, side) {
  if (side === "start") {
    // Використовуємо метод padStart(), щоб доповнити рядок original до певної довжини length,
    // вставляючи символи padWith на початку
    return original.padStart(length, padWith);
  } else if (side === "end") {
    // Використовуємо метод padEnd(), щоб доповнити рядок original до певної довжини length,
    // вставляючи символи padWith на кінці
